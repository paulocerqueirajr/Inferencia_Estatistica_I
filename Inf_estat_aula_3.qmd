...
$$\ell^{''}(\theta\mid x)=\dfrac{d}{d\theta}\ell^{'}(\theta\mid x)\mid_{\theta=\hat{\theta}}<0.$$
...
$$\ell(\theta\mid \textbf{x}, \textbf{y})=\log L(\theta\mid \textbf{x}, \textbf{y})=\log L(\theta\mid \textbf{x})\times \log L(\theta\mid \textbf{y})=\ell(\theta\mid \textbf{x})\times \ell(\theta\mid \textbf{y})$$
